...
then
  ...
  run_and_watch_status COMPUCELL3D_CMAKE_CONFIG cmake -G "Unix Makefiles" -DCOMPUCELL3D_A_MAJOR_VERSION:STRING=3 -DCOMPUCELL3D_B_MINOR_VERSION:STRING=7 -DCOMPUCELL3D_C_MAJOR_BUILD:STRING=1 -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_PREFIX $SOURCE_ROOT/CompuCell3D 
