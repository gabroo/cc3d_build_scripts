...
import shutil
# example command:
# python ./deb-pkg-builder-373.py -d /usr/share/compucell3d -i ~/cc3d_deb_pkg -v 3.7.3
...
parser.add_option("-v", "--version", dest="version",action="store", type="string",help="CC3D version", default='3.7.2')
