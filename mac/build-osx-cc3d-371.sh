# example command ./build-osx-cc3d-371.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.1 -r=~/RR_OSX -d=/Users/Shared/CC3Ddev/Dependencies -b=CC3D_3.7.1_MacOSX_10.8 -c=4
