# example command ./build-osx-cc3d-372.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.2 -r=~/RR_OSX -d=/Users/Shared/CC3Ddev/Dependencies -b=CC3D_3.7.2_MacOSX_10.8 -c=4
