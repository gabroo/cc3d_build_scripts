# example command ./build-snow-cc3d-gcc-4.8-372.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.2 -r=~/RR_OSX -d=/Users/Shared/Deps -b=CC3D_3.7.2_MacOSX_10.6_64bit -c=4
