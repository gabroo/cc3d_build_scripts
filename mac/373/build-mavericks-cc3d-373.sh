# example command ./build-mavericks-cc3d-373.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.3 -d=/Users/Shared/CC3Ddev/Dependencies -b=CC3D_3.7.3_MacOSX_10.9 -c=8
...
export INSTALL_PREFIX=~/install_projects/CC3D_3.7.3
