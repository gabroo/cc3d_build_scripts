# example command ./build-snow-cc3d-gcc-4.8-371.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.1 -r=~/RR_OSX -d=/Users/Shared/Deps -b=CC3D_3.7.1_MacOSX_10.8_32bit -c=4
