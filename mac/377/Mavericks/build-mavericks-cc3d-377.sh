# example command ./build-mavericks-cc3d-377.sh -s=~/CC3D_GIT p=~/install_projects/CC3D_3.7.7 -d=/Users/m/prerequisites/3.7.7 -b=CC3D_3.7.7_MacOSX_10.9 -c=8
...
export INSTALL_PREFIX=~/install_projects/CC3D_3.7.7
export RR_SOURCE_ROOT=~/RR_OSX
#mac variables
export GCC_DIR=/usr/local/Cellar/gcc48/4.8.2/
export MAC_DEPS=/Users/m/prerequisites/3.7.7
export VTK_BIN_AND_BUILD_DIR=${MAC_DEPS}/vtk
...
# export RR_INSTALL_PATH=/Users/Shared/roadrunner-1.4.2
export RR_INSTALL_PATH=/Users/Shared/roadrunner-1.5
...
then
  ...
  run_and_watch_status COMPUCELL3D_CMAKE_CONFIG cmake\
