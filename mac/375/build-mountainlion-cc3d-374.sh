# example command ./build-mountainlion-cc3d-375.sh -s=~/CC3D_GIT -p=~/install_projects/CC3D_3.7.5-r=~/RR_OSX -d=/Users/Shared/CC3Ddev/Dependencies -b=CC3D_3.7.5_MacOSX_10.8 -c=4
