...
cd $CC3D_BUILD_SCRIPTS_GIT_DIR/linux/374

time run_and_watch_status BUILDING_CC3D_374_COMPILER_FARM_SCRIPT  ./build-debian-cc3d-374.sh -s=$CC3D_GIT_DIR -p=$install_path -c=$number_of_cpus

cd $CC3D_BUILD_SCRIPTS_GIT_DIR/linux/374/DebianPackageBuilder
...
python ./deb-pkg-builder-374.py -d $install_path -i ${install_path}_deb -v ${VERSION}
