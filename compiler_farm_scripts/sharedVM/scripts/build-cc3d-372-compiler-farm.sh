...
cd $CC3D_BUILD_SCRIPTS_GIT_DIR/linux/372
...
cd $CC3D_BUILD_SCRIPTS_GIT_DIR/linux/372/DebianPackageBuilder

# remove old deb packages
rm -rf ${install_path}_deb/*

python ./deb-pkg-builder-372.py -d $install_path -i ${install_path}_deb -v ${VERSION}
