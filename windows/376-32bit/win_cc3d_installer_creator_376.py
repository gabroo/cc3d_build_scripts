...
# example command:
# python .\win_cc3d_installer_creator_376.py -d D:\install_projects\3.7.6 -v 3.7.6.0

# this is the path to the NSIS instaler executable
NSIS_EXE_PATH='C:\Program Files (x86)\NSIS\makensis.exe '

INSTALLER_TEMPLATE_NAME='CompuCell3D_376.nsi.tpl'
...
parser.add_option("-v", "--version", dest="version",action="store", type="string",help="CC3D version", default='3.7.6.0')
