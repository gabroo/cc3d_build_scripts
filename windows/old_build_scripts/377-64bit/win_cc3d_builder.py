...
c:\miniconda64\python .\win_cc3d_builder.py  -p D:/install_projects/3.7.7-64bit-gpu -s D:/CC3D_GIT  -i D:/CC3D_FILES_SVN/binaries/3.7.7/windows -v 3.7.7.0 --config=config_64bit.json --gpu

3 . 32bit no open cl modules:

c:\miniconda64\python .\win_cc3d_builder.py  -p D:/install_projects/3.7.7-32bit -s D:/CC3D_GIT  -i D:/CC3D_FILES_SVN/binaries/3.7.7/windows -v 3.7.7.0 --config=config_32bit.json
