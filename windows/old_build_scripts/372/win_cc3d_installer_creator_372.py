...
# example command:
# python .\win_cc3d_installer_creator.py -d 'D:\install_projects\3.7.2' -v 3.7.2.0
...
parser.add_option("-v", "--version", dest="version",action="store", type="string",help="CC3D version", default='3.7.2.0')
...
INSTALLER_TEMPLATE_NAME='CompuCell3D_372.nsi.tpl'
