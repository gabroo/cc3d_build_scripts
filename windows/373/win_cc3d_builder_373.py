# example command:
# python .\win_cc3d_builder_373.py  -p D:/install_projects/3.7.3 -s D:/CC3D_GIT  -i D:/CC3D_FILES_SVN/binaries/3.7.3/windows -v 3.7.3.0
...
parser = OptionParser()
parser.add_option("-p", "--prefix", dest="prefix",action="store", type="string",default='D:/install_projects/3.7.3', help="CC3D installation directory")
...
WIN_INSTALLER_CREATOR='win_cc3d_installer_creator_373.py'
