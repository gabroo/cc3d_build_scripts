# example command:
# python .\win_cc3d_builder_no_gpu_374.py  -p D:\install_projects\3.7.4_no_gpu -s D:\CC3D_GIT  -i D:\CC3D_FILES_SVN\binaries\3.7.4\windows -v 3.7.4.0
...
win_installer_creator='win_cc3d_installer_creator_374.py'
