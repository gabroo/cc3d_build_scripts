...
# example command:
# python .\win_cc3d_installer_creator_375.py -d D:\install_projects\3.7.5-32bit -v 3.7.5.0

# this is the path to the NSIS instaler executable
NSIS_EXE_PATH='C:\Program Files (x86)\NSIS\makensis.exe '

INSTALLER_TEMPLATE_NAME='CompuCell3D_375.nsi.tpl'
...
parser.add_option("-v", "--version", dest="version",action="store", type="string",help="CC3D version", default='3.7.5.0')
...
if INSTALLER_NAME=='':
    ...
    INSTALLER_NAME=os.path.abspath(os.path.join(cwd,'CompuCell3D-32bit-setup-'+version+'v'+revisionNumber+'.exe'))
else:    
