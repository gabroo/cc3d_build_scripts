# example command:
# c:\miniconda64\python .\win_cc3d_builder_no_gpu_375.py  -p D:/install_projects/3.7.5-nogpu-64bit -s D:/CC3D_GIT  -i D:/CC3D_FILES_SVN/binaries/3.7.5/windows -v 3.7.5.0
...
if  BUILD_INSTALLER:    
    ...
    INSTALLER_NAME=os.path.abspath(os.path.join(INSTALLER_DIR,'CompuCell3D-64bit-nogpu-setup-'+version+'v'+revisionNumber+'.exe'))
